...
@font-face {
    ...
    font-style: normal;
    font-weight: 400;
    src: url('https://fonts.gstatic.com/s/Roboto_Serif/v15/JTUSjIg1_i6t8kCHKm45xW5rygbi49c.woff2') format('woff2'),
    url('https://fonts.gstatic.com/s/Roboto_Serif/v15/JTUSjIg1_i6t8kCHKm45xW5rygbj49c.woff') format('woff');
}
...
@font-face {
    ...
    font-style: normal;
    font-weight: 700;
    src: url('https://fonts.gstatic.com/s/Roboto_Serif/v15/JTURjIg1_i6t8kCHKm45_dJE3gnD-w.woff2') format('woff2'),
    url('https://fonts.gstatic.com/s/Roboto_Serif/v15/JTURjIg1_i6t8kCHKm45_dJE3g3D_w.woff') format('woff');
}
```
